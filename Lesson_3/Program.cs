...
if (Qvartnum == 0)
    ...
    Console.Write("Number of qvart is " + Qvartnum);
*/
...
{
    if (q == 1)
    Console.Write("Диапазон координат точки Х > 0 и У > 0");
    else if (q == 2)
        Console.Write("Диапазон координат точки Х < 0 и У > 0");
    else if (q == 3)
        Console.Write("Диапазон координат точки Х < 0 и У < 0"); 
        ...
        Console.Write("Точка расположена на оси"); 
}
...
Console.Write(Rasst2dot(x1, y1, x2, y2));
*/
